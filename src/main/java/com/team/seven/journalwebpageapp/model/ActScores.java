...
@NamedQueries({
    ...
    @NamedQuery(name = "ActScores.findByStudentAndActivitytId", query = "SELECT a FROM ActScores a WHERE a.studentId = :studentId AND a.activityId = :activityId ORDER BY a.id"),
